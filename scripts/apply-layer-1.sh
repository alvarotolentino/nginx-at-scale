...
# ---- base host tuning: CPU governor = performance ---------------------------
# Part of the base tuning every layer inherits (introduced here at Layer 1, the host
# layer). Forces max clock under load and persists across reboots. See _lib.sh for
# the rationale — this was a large share of the measured ~2x throughput gain.
